...
<head>
        ...
        <link rel="shortcut icon" href="<?=$config_base?>admin/assets/dist/img/logo.png" type="image/x-icon" />
        ...
        <link href="assets/dist/css/login.css?v=<?=$config['version']?>" rel="stylesheet">
            ...
            <div class="content-wrapper">
                ...
                <footer class="footer-content">
                    ...
                    <div class="footer-text d-flex align-items-center justify-content-between">
                        ...
                        <div class="copy">© 2022 Dashboard bmweb Template</div>
