<?php 
	...
	$attr_page = array(
	    ...
	    array("tbl"=>"lists","field"=>"idl","source"=>"products","com"=>"khoa-hoc","type"=>"khoa-hoc"),
	    array("tbl"=>"cats","field"=>"idc","source"=>"products","com"=>"khoa-hoc","type"=>"khoa-hoc"),
	    array("tbl"=>"products","field"=>"id","source"=>"products","com"=>"khoa-hoc","type"=>"khoa-hoc"),

	    array("tbl"=>"posts","field"=>"id","source"=>"posts","com"=>"tin-tuc","type"=>"tin-tuc"),
	    array("tbl"=>"posts","field"=>"id","source"=>"posts","com"=>"du-an","type"=>"du-an"),
	    array("tbl"=>"posts","field"=>"id","source"=>"posts","com"=>"hoi-dap","type"=>"hoi-dap"),
	    ...
	    array("tbl"=>"course","field"=>"id","source"=>"courses","com"=>"dang-ky-khoa-hoc","type"=>"dang-ky-khoa-hoc"),
	    array("tbl"=>"multi_photos","field"=>"id","source"=>"multi_photos","com"=>"tai-lieu","type"=>"album")
	);
	if($com){
	...
	switch ($com) {
		...
		case 'khoa-hoc':
			$title = $title_seo = "Khóa học";
			$type = 'khoa-hoc';
			$source = "products";
			$type_ob = isset($_GET['id']) ? "article" : "object";
			$template = isset($_GET['id']) ? "products/khoahoc_detail" : "products/khoahoc";
			break;
		...
		case 'dang-ky-khoa-hoc':
			$title = $title_seo = "Đăng ký khóa học";
			$type = 'dang-ky-khoa-hoc';
			$source = "courses";
			$type_ob = "object";
